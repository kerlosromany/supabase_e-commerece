...
class MainUpdateWatchScreen extends StatefulWidget {
  final String tableName;
  final WatchModel watchModel;

  const MainUpdateWatchScreen({
    super.key,
  ...
  @override
  State<MainUpdateWatchScreen> createState() => _MainUpdateWatchScreenState();
}

class _MainUpdateWatchScreenState extends State<MainUpdateWatchScreen> {
  ...
  void initState() {
    ...
    priceController =
        TextEditingController(text: widget.watchModel.productPrice.toString());
    isAvailable = widget.watchModel.productAvailable;
  }
